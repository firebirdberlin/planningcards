...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        */
		...
		String[] texts = new String[] {"0", "1/2", "1", "2", "3", "5", "8", "13", "20", "40", "100", "?"};
		...
		for (String text : texts) {
			...
			ScaleGestureDetector scaleGestureDetector = new ScaleGestureDetector(this, new ScaleListener(drawViews));
			
	        MyTouchListener onTouchListener = new MyTouchListener(gestureDetector, scaleGestureDetector);
